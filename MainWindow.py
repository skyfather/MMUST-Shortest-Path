...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "<html><head/><body><p align=\"right\"><span style=\" color:#0000ff;\">Admin</span></p></body></html>"))
        MainWindow.setWindowIcon(QIcon('pics\\icon.png'))

    def navigate(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = Ui_ShortestPath22()
        self.ui.setupShortestPath22(self.window)
        self.window.show()
